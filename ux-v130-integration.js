(function(){
  ...
  api.bindSwipe=bindSwipe;api.closeSwipes=closeSwipes;api.createAutoScroll=createAutoScroll;api.syncNav=syncNav;api.updateFixedStack=updateFixedStack;api.registerDataProvider=registerDataProvider;
