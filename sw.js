const CACHE='stretch-timer-v36';
const APP_VERSION='0.12.22';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./ux-v22.js?v=36','./ux-v18.js?v=36','./ux-v26-detail.js?v=36','./ux-v34-timer.js?v=36','./ux-v35-history.js?v=36','./ux-v36-sample.js?v=36'];
...
(function(){
  ...
  html=html.replace('</body>',
    '<script src="./ux-v22.js?v=36"></script>'+
    '<script src="./ux-v18.js?v=36"></script>'+
    '<script src="./ux-v26-detail.js?v=36"></script>'+
    '<script src="./ux-v34-timer.js?v=36"></script>'+
    '<script src="./ux-v35-history.js?v=36"></script>'+
    '<script src="./ux-v36-sample.js?v=36"></script></body>'
  );
  return html;
}
