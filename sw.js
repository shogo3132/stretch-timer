const CACHE='stretch-timer-v193';
...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v22.js?v=163"></script>'+
    '<script src="./ux-v18.js?v=158"></script>'+
    ...
    '<script src="./ux-v79-item-editor-core.js?v=167"></script>'+
    ...
    '<script src="./ux-v96-native-pip.js?v=165"></script>'+
