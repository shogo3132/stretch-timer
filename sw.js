...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v96-native-pip.js?v=164"></script>'+
    '<script src="./ux-v106-tasks.js?v=169"></script>'+
    ...
    '<script src="./ux-v113-daily-schedule.js?v=178"></script>'+
