...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v51-update-watch.js?v=117"></script>'+
    ...
    '<script src="./ux-v106-tasks.js?v=117"></script></body>'
  );
  return html;
}
