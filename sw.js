...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v106-tasks.js?v=137"></script>'+
    ...
    '<script src="./ux-v113-daily-schedule.js?v=137"></script>'+
