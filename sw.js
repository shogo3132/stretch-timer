...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v106-tasks.js?v=170"></script>'+
    ...
    '<script src="./ux-v113-daily-schedule.js?v=180"></script>'+
