...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v106-tasks.js?v=134"></script>'+
    ...
    '<script src="./ux-v113-daily-schedule.js?v=134"></script>'+
    '<script src="./ux-v116-device-lock.js?v=134"></script>'+
