const CACHE='stretch-timer-v192';
...
(function(){
  ...
  html=html.replace('</body>',
    ...
    '<script src="./ux-v22.js?v=162"></script>'+
    ...
    '<script src="./ux-v79-item-editor-core.js?v=166"></script>'+
    ...
    '<script src="./ux-v81-timer-edit-save.js?v=162"></script>'+
    ...
    '<script src="./ux-v106-tasks.js?v=171"></script>'+
