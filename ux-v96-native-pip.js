...
body.native-pip #timerContent{position:relative!important;width:100%!important;height:100%!important;max-width:none!important;margin:0!important;padding-bottom:22px!important;display:grid!important;grid-template-rows:auto minmax(0,1fr)!important;align-content:stretch!important;justify-content:stretch!important;gap:4px!important;overflow:hidden!important;text-align:center!important}\
body.native-pip.native-pip-has-image #timerContent{grid-template-columns:minmax(82px,31%) minmax(0,1fr)!important;grid-template-rows:auto minmax(0,1fr)!important;column-gap:10px!important;row-gap:5px!important}\
...
body.native-pip.native-pip-has-image .timer-image-wrap{grid-column:1!important;grid-row:1/3!important}\
...
body.native-pip .compact-skip{display:none!important}\
...
body.native-pip .compact-seconds.is-clock{font-size:clamp(24px,14vh,42px)!important;letter-spacing:-1px!important}\
body.native-pip .compact-progress{display:none!important}\
body.native-pip .compact-progress-fill{background:#27ae8b!important}\
body.native-pip .routine-total-progress{position:absolute!important;left:0!important;right:0!important;bottom:0!important;z-index:2!important;display:grid!important;gap:3px!important;width:100%!important;padding:0!important;background:transparent!important}\
